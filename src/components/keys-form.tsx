          ...
          <div key={p.id} className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-5 pt-1">
              <button
                ...
                onClick={() => save(p.id)}
                className="font-mono text-xs text-zinc-400 hover:text-zinc-100 disabled:opacity-30"
              >
              ...
              {st.set ? (
                <>
                  <button
                    ...
                    disabled={pending}
                    onClick={() => test(p.id)}
                    className="font-mono text-xs text-zinc-600 hover:text-zinc-300 disabled:opacity-30"
                  >
                  ...
                  <button
                    ...
                    disabled={pending}
                    onClick={() => clear(p.id)}
                    className="font-mono text-xs text-zinc-700 hover:text-zinc-400 disabled:opacity-30"
                  >
                    clear
                  </button>
                </>
